---
title: Install Snort 3 and the required dependencies
weight: 2
...
To enable multithreading in Snort 3, you need to specify the number of threads designated for processing network traffic using either the `--max-packet-threads` or `-z` option. 
...
## Installing, compiling and building Snort 3
...
Proceed to learn how to test Snort 3 multithreading.